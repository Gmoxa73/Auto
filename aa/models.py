...
class Note(models.Model):
    ...
    address = models.ForeignKey('Addresses', on_delete=models.CASCADE, related_name='back_note')
...
class Devices(models.Model):
    ...
    address = models.ForeignKey('Addresses', on_delete=models.CASCADE, related_name='back_device')
